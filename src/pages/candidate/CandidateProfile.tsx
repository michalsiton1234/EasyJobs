...
//           level: p.level || "easy",
//           IsRemoteOnly: p.IsRemoteOnly || false,
...
//           // לא מבצעים רדיירקט אוטומטי - מאפשרים למשתמש להחליט
...
//       // בדיקה אם הבקאנד החזיר טוקן חדש
//       if (response.data.token) {
//         console.log("🔄 Backend returned new token, updating...");
//         localStorage.setItem('token', response.data.token);
//         // ניתן להוסיף כאן עדכון של AuthContext אם צריך
//       }
//     } catch (e1) {
...
//           // בדיקה אם הבקאנד החזיר טוקן חדש גם ב-PUT
//           if (response.data.token) {
//             console.log("🔄 Backend returned new token in PUT, updating...");
//             localStorage.setItem('token', response.data.token);
//           }
//         } catch (e2) {
...
//       // לא צריך לטעון מחדש את הנתונים כי אנחנו עוברים לדף אחר
//       console.log("✅ Profile saved successfully, navigating to my-area");
//       // מעבר לאזור האישי של המועמד
//       setTimeout(() => {
