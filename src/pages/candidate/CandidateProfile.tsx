...
import ProfileForm from "@/components1/candidate/ProfileForm";
import "@/style/candidate/CandidateProfile.css";

export default function CandidateProfile() {
  const { loading, saving, error, form, setForm, categories, handleSave } =
    useCandidateProfile();
    ...
    return (
      <div className="candidate-loader">
        <div className="text-center">
          ...
          <p className="candidate-loader-text">טוען פרופיל...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="candidate-profile-page" dir="rtl">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="max-w-2xl mx-auto"
      >
        <div className="candidate-header">
          ...
          <h1 className="candidate-title">פרופיל מועמד</h1>
        </div>
